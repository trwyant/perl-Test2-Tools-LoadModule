...
This subroutine takes as its argument the number of tests to skip
(defaulting to 1). If running under a version of Perl earlier than
5.10.0, it issues a skip; otherwise it simply returns.
